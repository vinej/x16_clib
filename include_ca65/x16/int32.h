...
int  __fastcall__ x16_i32_to_s16 (long v);
...
long __fastcall__ x16_i32_abs (long a);   /* |-2147483648| stays put */
long __fastcall__ x16_i32_mul (long a, long b);

/* Shift by ONE, three ways: left, logical right (zero fill), and
** arithmetic right (sign fill).
*/
long          __fastcall__ x16_i32_shl (long a);
unsigned long __fastcall__ x16_i32_shr (unsigned long a);
long          __fastcall__ x16_i32_asr (long a);
