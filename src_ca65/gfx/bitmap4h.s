...
; =====================================================================
        ...
        .export         _x16_gfx4h_has
        .export         _x16_gfx4h_init
        .export         _x16_gfx4h_off
        .export         _x16_gfx4h_passthru_on
        .export         _x16_gfx4h_passthru_off
        .export         _x16_gfx4h_pal_gray
        .export         _x16_gfx4h_pal_set
        .export         _x16_gfx4h_pal_load
        .export         _x16_gfx4h_setptr
        .export         _x16_gfx4h_clear
        .export         _x16_gfx4h_pset
        .export         _x16_gfx4h_read
        .export         _x16_gfx4h_hline
        .export         _x16_gfx4h_vline
        .export         _x16_gfx4h_rect
        .export         _x16_gfx4h_frame
        .export         _x16_gfx4h_line
        .export         _x16_gfx4h_pattern_set
        .export         _x16_gfx4h_pattern_rect
        .export         _x16_gfx4h_blit
        .export         _x16_gfx4h_blitm
        .export         _x16_gfx4h_copy
        .export         _x16_gfx4h_copy_wait
...
; void __fastcall__ x16_gfx4h_pal_set(unsigned char index,
...
; void __fastcall__ x16_gfx4h_pal_load(const unsigned char *src,
;                                     unsigned char first,
;                                     unsigned char count)
_x16_gfx4h_pal_load:
        sta     g4sh_c                  ; count
...
; void __fastcall__ x16_gfx4h_setptr(unsigned char inc,
...
; void __fastcall__ x16_gfx4h_clear(unsigned char color)
_x16_gfx4h_clear:
        jmp     gfx4h_clear

; void __fastcall__ x16_gfx4h_pset(unsigned int x, unsigned int y,
;                                 unsigned char color)
_x16_gfx4h_pset:
        sta     g4sh_c
        jsr     popax
...
; unsigned char __fastcall__ x16_gfx4h_read(unsigned int x, unsigned int y)
...
; void __fastcall__ x16_gfx4h_hline(unsigned int x, unsigned int y,
...
; void __fastcall__ x16_gfx4h_vline(unsigned int x, unsigned int y,
;                                  unsigned int len, unsigned char color)
_x16_gfx4h_vline:
        sta     g4sh_c
        jsr     popax
...
; void __fastcall__ x16_gfx4h_rect(unsigned int x, unsigned int y,
...
; void __fastcall__ x16_gfx4h_frame(unsigned int x, unsigned int y,
;                                  unsigned int w, unsigned int h,
;                                  unsigned char color)
_x16_gfx4h_frame:
        sta     g4sh_c
...
; void __fastcall__ x16_gfx4h_line(unsigned int x0, unsigned int y0,
...
; void __fastcall__ x16_gfx4h_pattern_set(const unsigned char *pattern,
...
; void __fastcall__ x16_gfx4h_pattern_rect(unsigned int x, unsigned int y,
;                                         unsigned int w, unsigned int h)
...
; void __fastcall__ x16_gfx4h_blit(unsigned int x, unsigned int y,
...
; void __fastcall__ x16_gfx4h_blitm(unsigned int x, unsigned int y,
;                                  unsigned char w, unsigned char h,
;                                  const unsigned char *src)
_x16_gfx4h_blitm:
        sta     X16_P6                  ; src
...
; void __fastcall__ x16_gfx4h_copy(unsigned long src, unsigned long dst,
;                                 unsigned long len)
