...
void __fastcall__ x16_fxu_ctrl_on (unsigned char bits);
void __fastcall__ x16_fxu_ctrl_off (unsigned char bits);

/* Set only the Addr1 Mode field (bits 1:0), leaving every flag alone. */
void __fastcall__ x16_fxu_addr1_mode (unsigned char mode);
...
*/
void __fastcall__ x16_fxu_set_mult (unsigned char v);
...
void __fastcall__ x16_fxu_cache_write1 (unsigned char mask);
...
*/
void __fastcall__ x16_fxu_set_tilebase (unsigned char v);
void __fastcall__ x16_fxu_set_mapbase (unsigned char v);
