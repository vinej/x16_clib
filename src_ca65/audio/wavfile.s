...
; =====================================================================
        ...
        .export         _x16_wav_parse_header
        .export         _x16_wav_get_info
        .export         _x16_wav_rate
        .export         _x16_wav_data_len
...
wav_format:   .res 1                    ; audio format code (1 = PCM)
wav_channels: .res 1                    ; channel count
wav_rate:     .res 4                    ; sample rate, little-endian
wav_bits:     .res 1                    ; bits per sample
wav_data_off: .res 2                    ; sample data offset in the buffer
wav_data_len: .res 4                    ; sample data length in bytes
WAV_INFO_SIZE = 13

; Chunk-walker scratch.
wavp_cur:     .res 2                    ; current chunk offset from the base
wavp_sz:      .res 4                    ; current chunk size
wavp_adv:     .res 2                    ; bytes to the next chunk
wavp_fmt:     .res 1                    ; have we seen a fmt chunk yet?
