...
; =====================================================================
        ...
        global	_x16_stack_init
        global	_x16_stack_push
        global	_x16_stack_pushw
        global	_x16_stack_pop
        global	_x16_stack_popw
        global	_x16_stack_size
        global	_x16_stack_free
        global	_x16_stack_isempty
        global	_x16_stack_isfull
...
_x16_stack_pushw:
        ...
        jmp     stack_pushw              ; routine below wants A/X
...
stack_bank: reserve 1              ; the HIRAM bank the stack owns
stack_sp:   reserve 2              ; 16-bit offset; grows down from STACK_TOP
