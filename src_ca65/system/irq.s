...
; =====================================================================
        ...
        .include        "macros.inc"
        .include        "x16zp.inc"
        .include        "zeropage.inc"          ; cc65's sp .. regbank, zpspace

        .export         _x16_irq_install
        .export         _x16_irq_remove
        .export         _x16_irq_frames
        .export         _x16_vsync_wait
        .export         _x16_irq_line_install
        .export         _x16_irq_line_remove
        .export         _x16_irq_sprcol_install
        .export         _x16_irq_sprcol_remove
        .export         _x16_sprite_collisions
...
_x16_irq_line_install:
        pha                             ; handler lo (rightmost arg: A/X)
        phx                             ; handler hi
        jsr     popax                   ; line
        sta     X16_P0
        stx     X16_P1
...
irq_armed:        .res 1
irq_isr:          .res 1                ; ISR snapshot for the current interrupt

irq_line_vec:     .res 2
irq_line_armed:   .res 1
irq_sprcol_vec:   .res 2
irq_sprcol_armed: .res 1
irq_sprcol_mask:  .res 1                ; groups seen since the last read
