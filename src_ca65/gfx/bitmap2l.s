...
; =====================================================================
        ...
        .export         _x16_gfx2l_init
        .export         _x16_gfx2l_clear
        .export         _x16_gfx2l_setptr
        .export         _x16_gfx2l_pset
        .export         _x16_gfx2l_read
        .export         _x16_gfx2l_hline
        .export         _x16_gfx2l_vline
        .export         _x16_gfx2l_rect
        .export         _x16_gfx2l_frame
        .export         _x16_gfx2l_line
        .export         _x16_gfx2l_pattern_set
        .export         _x16_gfx2l_pattern_rect
        .export         _x16_gfx2l_blit
        .export         _x16_gfx2l_blitm
...
; void __fastcall__ x16_gfx2l_clear(unsigned char color)
_x16_gfx2l_clear:
        jmp     gfx2l_clear

; unsigned char __fastcall__ x16_gfx2l_setptr(unsigned char inc,
...
; void __fastcall__ x16_gfx2l_pset(unsigned int x, unsigned int y,
;                                 unsigned char color)
_x16_gfx2l_pset:
        sta     g2sl_c
        jsr     popax
...
; unsigned char __fastcall__ x16_gfx2l_read(unsigned int x, unsigned int y)
...
; void __fastcall__ x16_gfx2l_hline(unsigned int x, unsigned int y,
...
; void __fastcall__ x16_gfx2l_vline(unsigned int x, unsigned int y,
;                                  unsigned int len, unsigned char color)
_x16_gfx2l_vline:
        sta     g2sl_c
        jsr     popax
...
; void __fastcall__ x16_gfx2l_rect(unsigned int x, unsigned int y,
...
; void __fastcall__ x16_gfx2l_frame(unsigned int x, unsigned int y,
;                                  unsigned int w, unsigned int h,
;                                  unsigned char color)
_x16_gfx2l_frame:
        sta     g2sl_c
...
; void __fastcall__ x16_gfx2l_line(unsigned int x0, unsigned int y0,
...
; void __fastcall__ x16_gfx2l_pattern_set(const unsigned char *pattern,
;                                        unsigned char colors)
;   colors = (background << 2) | foreground
_x16_gfx2l_pattern_set:
        sta     g2sl_c                  ; colors
        jsr     popax                   ; pattern -> A/X
        ldy     g2sl_c
        jmp     gfx2l_pattern_set

; void __fastcall__ x16_gfx2l_pattern_rect(unsigned int x, unsigned int y,
;                                         unsigned int w, unsigned int h)
_x16_gfx2l_pattern_rect:
        sta     X16_P6                  ; h
        stx     X16_P7
        jsr     popax
        sta     X16_P4                  ; w
...
; void __fastcall__ x16_gfx2l_blit(unsigned int x, unsigned int y,
...
; void __fastcall__ x16_gfx2l_blitm(unsigned int x, unsigned int y,
