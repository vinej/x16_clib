 ...
 * Address increments.
 *
 * These are raw indices, 0-15, matching the cc65 build. Beware that
 * other X16 headers in the wild define VERA_INC_1 and friends already
 * shifted into ADDR_H bits 7:4 -- same bits on the wire, sixteen times
 * apart as constants. Pass only the X16_-prefixed ones to this header.
 *
