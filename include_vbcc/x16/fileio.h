 ...
 *      x16_fio_chrout(__reg("a") ...);            // as many as you like
 *      x16_fio_close_named(__reg("a") 2);
 *
...
void x16_fio_set_lfs (__reg("r0") unsigned char lfn,
                __reg("r2") unsigned char device,
                __reg("r4") unsigned char secondary);
void x16_fio_set_name (__reg("r0/r1") const char *name,
...
void x16_fio_close (__reg("a") unsigned char lfn);

/* Select a logical file for input/output. 0 on success, else the KERNAL
** error code (3 = file not open).
*/
unsigned char x16_fio_chkin (__reg("a") unsigned char lfn);
unsigned char x16_fio_chkout (__reg("a") unsigned char lfn);
...
void x16_fio_chrout (__reg("a") unsigned char b);
...
void x16_fio_close_device (__reg("a") unsigned char device);
...
/* CLRCHN + CLOSE. */
void x16_fio_close_named (__reg("a") unsigned char lfn);
