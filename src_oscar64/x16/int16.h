 ...
 * computes nothing Oscar64's `+` does not. The module is here anyway, for
 ...
 * back quotient AND remainder from one division (`/` and `%` divide
 * twice), x16_i16_sqrt() is an integer square root the language
...
int x16_i16_abs (int a);         /* |-32768| stays -32768 */
