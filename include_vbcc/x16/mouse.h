...
*/
void x16_mse_config (__reg("r0") unsigned char show,
               __reg("r2") unsigned char width8,
               __reg("r4") unsigned char height8);
...
*/
signed char x16_mse_get (__reg("r0/r1") unsigned int *x,
            __reg("r2/r3") unsigned int *y,
            __reg("r4/r5") unsigned char *buttons);
