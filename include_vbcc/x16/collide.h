...
**
** No __reg() here: with eight char arguments the entry uses vbcc's
** default placement (the first four in r0/r2/r4/r6, the rest on the C
** soft stack), which is exactly what the asm entry reads.
**
