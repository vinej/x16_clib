...
volatile unsigned char x16__pm_si;        // string index
volatile unsigned char x16__pm_pi;        // pattern index
volatile unsigned char x16__pm_star_pi;   // just past the last '*'
volatile unsigned char x16__pm_star_si;   // what it has swallowed
volatile unsigned char x16__pm_have_star;
volatile unsigned char x16__pm_state;     // 2 walking, 1 done, 0 no
