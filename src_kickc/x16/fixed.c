...
__mem volatile char x16__fx_mcand[2];
__mem volatile char x16__fx_mplier[2];        // consumed by the core
__mem volatile char x16__fx_prod[4];
__mem volatile char x16__fx_sign;
...
unsigned long x16_umul16(__mem unsigned int a, __mem unsigned int b) {
    __mem unsigned long r;
    asm {
        lda a
        sta x16__fx_mcand
        lda a+1
...
// ---------------------------------------------------------------------
int x16_mul88(__mem int a, __mem int b) {
    __mem int r;
    asm {
        stz x16__fx_sign
