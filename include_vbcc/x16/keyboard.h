...
*/
void x16_kbd_put (__reg("a") unsigned char key);
...
** the layout index.
*/
unsigned char x16_kbd_get_keymap (__reg("a/x") char *name);
...
*/
unsigned char x16_kbd_set_keymap (__reg("a/x") const char *name);
