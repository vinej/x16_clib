...
; vbcc argument registers: set_state takes predictor in r0/r1 and index in
; r2; adpcm_block takes src in r0/r1, dst in r2/r3, count in r4/r5.
        zpage	r0
        zpage	r1
        zpage	r2
        zpage	r3
        ...
        global	_x16_adpcm_init
        global	_x16_adpcm_nibble
        global	_x16_adpcm_block
        global	_x16_adpcm_set_state
        global	_x16_adpcm_predictor
        global	_x16_adpcm_index
...
;   adpcm_block wants P0/P1 = src, P2/P3 = dst, P4/P5 = source count.
_x16_adpcm_block:
        lda     r0
        sta     X16_P0                  ; src
        lda     r1
...
adpcm_pred:  reserve 2                     ; the predictor (signed 16-bit sample)
adpcm_index: reserve 1                     ; step table index 0-88
