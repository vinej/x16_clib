...
// The operand block.
__mem volatile unsigned int x16__g8h_x;
__mem volatile unsigned int x16__g8h_y;
__mem volatile char x16__g8h_a0;         // the 20-bit SDRAM byte address
__mem volatile char x16__g8h_a1;
__mem volatile char x16__g8h_a2;
__mem volatile char x16__g8h_c;
__mem volatile char x16__g8h_off;
__mem volatile char x16__g8h_t;
__mem volatile unsigned int x16__g8h_n;

// Pattern state: raw rows plus the two colours (the 4l way).
__mem volatile char x16__g8h_pat[8];
__mem volatile char x16__g8h_pfg;
__mem volatile char x16__g8h_pbg;

// Blit source, pinned in the shared $78 pointer slot (see x16/zpsafe.h).
__address(0x78) const char* volatile x16__g8h_src;
...
// ---------------------------------------------------------------------
void x16__gfx8h_aim(__mem unsigned char incr) {
    asm {
        lda x16__g8h_a0
...
void x16_gfx8h_blit(unsigned int x, unsigned int y, unsigned char w,
    ...
    for (brow = 0; brow < h; brow++) {
        if (op == 0) {
            ...
            for (i = 0; i < w; i++) {
                ink = (unsigned char)x16__g8h_src[i];
...
void x16_gfx8h_copy(__mem unsigned long src, __mem unsigned long dst,
