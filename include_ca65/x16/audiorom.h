 ...
 * ------------------------------------------------------------------ */
unsigned char __fastcall__ x16_ar_fmfreq (unsigned char channel,
                                          unsigned int hz,
                                          unsigned char noretrigger);
unsigned char __fastcall__ x16_ar_fmnote (unsigned char channel,
                                          unsigned char octnote,
                                          unsigned char kf,
                                          unsigned char noretrigger);
unsigned char __fastcall__ x16_ar_fmvib (unsigned char speed,
                                         unsigned char depth);
unsigned char __fastcall__ x16_ar_psgfreq (unsigned char voice,
                                           unsigned int hz);
unsigned char __fastcall__ x16_ar_psgnote (unsigned char voice,
                                           unsigned char octnote,
                                           unsigned char kf);
unsigned char __fastcall__ x16_ar_psgwav (unsigned char voice,
...
*/
void __fastcall__ x16_ar_playstring_voice (unsigned char voice);
void __fastcall__ x16_ar_fmplaystring (const char *s, unsigned char len);
void __fastcall__ x16_ar_psgplaystring (const char *s, unsigned char len);
void __fastcall__ x16_ar_fmchordstring (const char *s, unsigned char len);
void __fastcall__ x16_ar_psgchordstring (const char *s, unsigned char len);
...
*/
unsigned char __fastcall__ x16_ar_note_bas2fm (unsigned char octnote);
unsigned char __fastcall__ x16_ar_note_bas2midi (unsigned char octnote);
unsigned int __fastcall__ x16_ar_note_bas2psg (unsigned char octnote,
                                               unsigned char kf);
unsigned char __fastcall__ x16_ar_note_fm2bas (unsigned char kc);
unsigned char __fastcall__ x16_ar_note_fm2midi (unsigned char kc);
unsigned int __fastcall__ x16_ar_note_fm2psg (unsigned char kc,
                                              unsigned char kf);
unsigned int __fastcall__ x16_ar_note_freq2bas (unsigned int hz);
unsigned int __fastcall__ x16_ar_note_freq2fm (unsigned int hz);
unsigned int __fastcall__ x16_ar_note_freq2midi (unsigned int hz);
unsigned int __fastcall__ x16_ar_note_freq2psg (unsigned int hz);
unsigned char __fastcall__ x16_ar_note_midi2bas (unsigned char midinote);
unsigned char __fastcall__ x16_ar_note_midi2fm (unsigned char midinote);
unsigned int __fastcall__ x16_ar_note_midi2psg (unsigned char midinote,
                                                unsigned char kf);
unsigned int __fastcall__ x16_ar_note_psg2bas (unsigned int freq);
unsigned int __fastcall__ x16_ar_note_psg2fm (unsigned int freq);
unsigned int __fastcall__ x16_ar_note_psg2midi (unsigned int freq);
...
void __fastcall__ x16_ar_psg_playfreq (unsigned char voice, unsigned int freq);
void __fastcall__ x16_ar_psg_setfreq (unsigned char voice, unsigned int freq);
void __fastcall__ x16_ar_psg_setvol (unsigned char voice, unsigned char vol);
void __fastcall__ x16_ar_psg_setatten (unsigned char voice, unsigned char atten);
void __fastcall__ x16_ar_psg_setpan (unsigned char voice, unsigned char pan);
unsigned char __fastcall__ x16_ar_psg_getatten (unsigned char voice);
unsigned char __fastcall__ x16_ar_psg_getpan (unsigned char voice);
...
*/
void __fastcall__ x16_ar_psg_write (unsigned char reg, unsigned char value);
void __fastcall__ x16_ar_psg_write_fast (unsigned char reg, unsigned char value);
unsigned char __fastcall__ x16_ar_psg_read (unsigned char reg,
...
unsigned char __fastcall__ x16_ar_ym_loadpatch (unsigned char channel,
                                                unsigned char patch);
unsigned char __fastcall__ x16_ar_ym_loadpatch_ram (unsigned char channel,
                                                    const void *patch);

/* Load a patch from an already-OPENed logical file. */
unsigned char __fastcall__ x16_ar_ym_loadpatchlfn (unsigned char channel,
                                                   unsigned char lfn);

unsigned char __fastcall__ x16_ar_ym_playnote (unsigned char channel,
                                               unsigned char kc,
                                               unsigned char kf,
                                               unsigned char noretrigger);
unsigned char __fastcall__ x16_ar_ym_playdrum (unsigned char channel,
                                               unsigned char midinote);
unsigned char __fastcall__ x16_ar_ym_setnote (unsigned char channel,
                                              unsigned char kc,
                                              unsigned char kf);
unsigned char __fastcall__ x16_ar_ym_setdrum (unsigned char channel,
                                              unsigned char midinote);
unsigned char __fastcall__ x16_ar_ym_trigger (unsigned char channel,
                                              unsigned char noretrigger);
unsigned char __fastcall__ x16_ar_ym_release (unsigned char channel);
unsigned char __fastcall__ x16_ar_ym_setatten (unsigned char channel,
                                               unsigned char atten);
unsigned char __fastcall__ x16_ar_ym_setpan (unsigned char channel,
                                             unsigned char pan);
unsigned char __fastcall__ x16_ar_ym_getatten (unsigned char channel);
unsigned char __fastcall__ x16_ar_ym_getpan (unsigned char channel);
...
*/
unsigned char __fastcall__ x16_ar_ym_write (unsigned char reg,
                                            unsigned char value);
unsigned char __fastcall__ x16_ar_ym_read (unsigned char reg,
                                           unsigned char cooked);
