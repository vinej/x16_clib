 ...
 *
 * This module never calls a drawing routine, so linking it does not drag
 * the bitmap module in behind it.
 * =====================================================================
 */
...
void x16_clip_set(__reg("r0/r1") unsigned int xmin, __reg("r2/r3") unsigned int ymin,
                  __reg("r4/r5") unsigned int xmax, __reg("r6/r7") unsigned int ymax);
