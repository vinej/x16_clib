...
volatile unsigned char x16__fi_v;
...
volatile unsigned char x16__fi_nlo;
volatile unsigned char x16__fi_nhi;
volatile unsigned char x16__fi_len;
volatile unsigned char x16__fi_lfn;
volatile unsigned char x16__fi_dev;
volatile unsigned char x16__fi_sec;
