...
; =====================================================================
        ...
        .globl  x16_stack_init
        .globl  x16_stack_push
        .globl  x16_stack_pushw
        .globl  x16_stack_pop
        .globl  x16_stack_popw
        .globl  x16_stack_size
        .globl  x16_stack_free
        .globl  x16_stack_isempty
        .globl  x16_stack_isfull
...
stack_bank: .zero  1              ; the HIRAM bank the stack owns
stack_sp:   .zero  2              ; 16-bit offset; grows down from STACK_TOP
