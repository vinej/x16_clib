/* GENERATED by tools/oscar64_double_gen.py from src_ca65/util/double.s -- do not edit.
...
double_dfr_nz:
    ...
    sta d_sticky
    pla
    plp        /* an integer converts exactly */
    jsr     double_d_norm
    jmp     double_d_pack
...
d_sub:
    ...
    jsr     double_d_unpack        /* operand -> dac_* */
    lda     dac_s
    eor     #0x80        /* subtract = add the negation */
    sta     dac_s
...
double_ddv_afin:
    ...
    jmp double_ddv_inf        /* x / 0 = inf */
double_ddv_bnz:
    lda     dac_c
    bne     double_ddv_div
    jmp double_ddv_zero        /* 0 / finite = 0 */
double_ddv_nan:
    lda     #D_NAN
    sta     dac_c
    jmp     double_d_pack
...
double_dun_normal:
    ...
    lda     d_ub+6
    and     #0x0F
    ora     #0x10        /* implicit leading 1 (bit 52 -> byte6 bit4) */
    sta     dac_m+6
    php
    pha
    lda #0
