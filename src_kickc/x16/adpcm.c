...
__mem volatile char x16__ad_pred0 = 0;  // the predictor (signed 16-bit)
__mem volatile char x16__ad_pred1 = 0;
__mem volatile char x16__ad_index = 0;  // step table index 0-88

__mem volatile char x16__ad_n;
__mem volatile char x16__ad_sh[2];
__mem volatile char x16__ad_diff[2];
__mem volatile char x16__ad_p[3];
...
void x16_adpcm_set_state(__mem int predictor, __mem unsigned char index) {
    asm {
        lda predictor
        sta x16__ad_pred0
        lda predictor+1
...
// ---------------------------------------------------------------------
int x16_adpcm_nibble(__mem unsigned char code) {
    __mem int r;
    asm {
        lda code
        sta x16__ad_n
