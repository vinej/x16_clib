...
void __fastcall__ x16_gfx8l_circle (unsigned int cx, unsigned char cy,
                                  unsigned char r, unsigned char color);
void __fastcall__ x16_gfx8l_disc (unsigned int cx, unsigned char cy,
                                unsigned char r, unsigned char color);
...
*/
void __fastcall__ x16_gfx8l_ellipse (unsigned int cx, unsigned char cy,
                                   unsigned char rx, unsigned char ry,
                                   unsigned char color);
void __fastcall__ x16_gfx8l_fellipse (unsigned int cx, unsigned char cy,
                                    unsigned char rx, unsigned char ry,
                                    unsigned char color);
...
*/
unsigned char __fastcall__ x16_gfx8l_flood (unsigned int x, unsigned char y,
                                          unsigned char color);
...
void __fastcall__ x16_gfx8l_polygon (unsigned int cx, unsigned char cy,
                                   unsigned char r, unsigned char sides,
                                   unsigned char rotation,
                                   unsigned char color);
void __fastcall__ x16_gfx8l_fpolygon (unsigned int cx, unsigned char cy,
                                    unsigned char r, unsigned char sides,
                                    unsigned char rotation,
                                    unsigned char color);
...
void __fastcall__ x16_gfx8l_rrect (unsigned int x, unsigned int y,
                                 unsigned int w, unsigned int h,
                                 unsigned char r, unsigned char color);
void __fastcall__ x16_gfx8l_frrect (unsigned int x, unsigned int y,
                                  unsigned int w, unsigned int h,
                                  unsigned char r, unsigned char color);

/* Arc: a circle-outline slice from byte-angle a0 to a1 (a0==a1 = full
** circle). x16_gfx8l_pie fills the matching wedge. */
void __fastcall__ x16_gfx8l_arc (unsigned int cx, unsigned char cy,
                               unsigned char r, unsigned char a0,
                               unsigned char a1, unsigned char color);
void __fastcall__ x16_gfx8l_pie (unsigned int cx, unsigned char cy,
                               unsigned char r, unsigned char a0,
                               unsigned char a1, unsigned char color);
...
void __fastcall__ x16_gfx8l_bezier (const unsigned int *pts,
                                  unsigned char color);

/* --- 2bpp (640x480) -------------------------------------------------- */

void __fastcall__ x16_gfx2h_circle (unsigned int cx, unsigned int cy,
                                   unsigned char r, unsigned char color);
void __fastcall__ x16_gfx2h_disc (unsigned int cx, unsigned int cy,
                                 unsigned char r, unsigned char color);

void __fastcall__ x16_gfx2h_ellipse (unsigned int cx, unsigned int cy,
                                    unsigned char rx, unsigned char ry,
                                    unsigned char color);
void __fastcall__ x16_gfx2h_fellipse (unsigned int cx, unsigned int cy,
                                     unsigned char rx, unsigned char ry,
                                     unsigned char color);

unsigned char __fastcall__ x16_gfx2h_flood (unsigned int x, unsigned int y,
                                           unsigned char color);

void __fastcall__ x16_gfx2h_polygon (unsigned int cx, unsigned int cy,
                                    unsigned char r, unsigned char sides,
                                    unsigned char rotation,
                                    unsigned char color);
void __fastcall__ x16_gfx2h_fpolygon (unsigned int cx, unsigned int cy,
                                     unsigned char r, unsigned char sides,
                                     unsigned char rotation,
                                     unsigned char color);

void __fastcall__ x16_gfx2h_rrect (unsigned int x, unsigned int y,
                                  unsigned int w, unsigned int h,
                                  unsigned char r, unsigned char color);
void __fastcall__ x16_gfx2h_frrect (unsigned int x, unsigned int y,
                                   unsigned int w, unsigned int h,
                                   unsigned char r, unsigned char color);

void __fastcall__ x16_gfx2h_arc (unsigned int cx, unsigned int cy,
                                unsigned char r, unsigned char a0,
                                unsigned char a1, unsigned char color);
void __fastcall__ x16_gfx2h_pie (unsigned int cx, unsigned int cy,
                                unsigned char r, unsigned char a0,
                                unsigned char a1, unsigned char color);

void __fastcall__ x16_gfx2h_bezier (const unsigned int *pts,
                                   unsigned char color);
