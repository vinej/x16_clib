...
; =====================================================================
        ...
        global	_x16_ring_init
        global	_x16_ring_put
        global	_x16_ring_putw
        global	_x16_ring_get
        global	_x16_ring_getw
        global	_x16_ring_size
        global	_x16_ring_free
        global	_x16_ring_isempty
        global	_x16_ring_isfull
...
_x16_ring_putw:
        lda     r0                      ; a lone 16-bit argument rides
        ldx     r1                      ; r0/r1, not A/X, and the
        jmp     ring_putw              ; routine below wants A/X
...
ring_bank: reserve 1              ; the HIRAM bank the queue owns
ring_fill: reserve 2              ; bytes currently queued
ring_head: reserve 2              ; where the next put goes
ring_tail: reserve 2              ; one before where the next get comes from
