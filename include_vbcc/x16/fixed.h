...
/* The pixel coordinate of an 8.8 value, rounding toward negative infinity
** -- an arithmetic shift, not a divide. */
#define X16_FIX_WHOLE(v)            ((int)(v) >> 8)

/* Unsigned 16 x 16 -> 32. */
unsigned long x16_umul16(__reg("r0/r1") unsigned int a, __reg("r2/r3") unsigned int b);
