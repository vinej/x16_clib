 ...
 * =====================================================================
 * Thin wrappers over the KERNAL's own input calls: no driver to
 * install, and the SNES pad's full button set is exposed.
 * =====================================================================
 */
...
/* Button bits from x16_joy_get(). ACTIVE LOW: a pressed button reads 0.
**
