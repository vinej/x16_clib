...
; =====================================================================
        ...
        .export         _x16_kbd_scan
        .export         _x16_kbd_put
        .export         _x16_kbd_get_modifiers
        .export         _x16_kbd_get_keymap
        .export         _x16_kbd_set_keymap
...
@copy:
        ...
        sta     (ptr1),y                ; trust it past the buffer's end
@done:
        pla
        sta     RAM_BANK
