...
; =====================================================================
        ...
        .export         _x16_ym_write
        .export         _x16_ym_busy
        .export         _x16_ym_init
        .export         _x16_ym_poke
        .export         _x16_ym_patch_rom
        .export         _x16_ym_patch_ram
        .export         _x16_ym_note
        .export         _x16_ym_note_bas
        .export         _x16_ym_release_note
        .export         _x16_ym_vol
        .export         _x16_ym_pan
        .export         _x16_ym_get_pan
        .export         _x16_ym_get_vol
        .export         _x16_ym_drum
...
; ---------------------------------------------------------------------
_x16_ym_patch_ram:
        sta     ym_tmp                  ; patch lo (rightmost arg: A/X)
        stx     ym_tmp+1                ; patch hi
        jsr     popa                    ; A = channel
        ldx     ym_tmp
        ldy     ym_tmp+1
        clc                             ; patch in RAM
...
; ---------------------------------------------------------------------
_x16_ym_note:
        sta     ym_tmp                  ; retrigger (rightmost arg, in A)
        jsr     popa
        sta     ym_tmp+1                ; kf
        jsr     popa
        tax                             ; kc -- popa preserves X hereafter
        jsr     popa                    ; A = channel
        ldy     ym_tmp+1                ; Y = kf
