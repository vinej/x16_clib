/* =====================================================================
 * x16clib :: test_oscar64/testlib.h -- tiny on-target assertion harness
 * =====================================================================
 * Header-only; include it from exactly one translation unit.
 *
 * Reproduces the byte-for-byte output contract of the other suites'
 * testlibs, so build_oscar64.ps1's stdout watcher works unchanged:
 *
 ...
 * build_oscar64.ps1 anchors its regex to the line start, and that anchor
