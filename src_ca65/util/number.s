...
; =====================================================================
        ...
        .export         _x16_u8_to_dec
        .export         _x16_u16_to_dec
        .export         _x16_s8_to_dec
        .export         _x16_s16_to_dec
        .export         _x16_u8_to_hex
        .export         _x16_u16_to_hex
        .export         _x16_u8_to_bin
        .export         _x16_u16_to_bin
        .export         _x16_dec_to_u16
...
;
;   The 8-bit values arrive in A, the 16-bit ones in A/X, and every
;   internal routine already returns A = buffer low, X = buffer high --
;   exactly cc65's pointer return.
; ---------------------------------------------------------------------
_x16_u8_to_dec:
        jmp     u8_to_dec
...
; ---------------------------------------------------------------------
_x16_dec_to_u16:
        sta     X16_T6                  ; value (rightmost arg, in A/X)
        stx     X16_T7
        jsr     popa                    ; len
        sta     X16_P2
        jsr     popax                   ; s
...
num_buf: .res 17                ; enough for 16 binary digits plus a terminator
