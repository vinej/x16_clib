...
; =====================================================================
        ...
        .import         ser_puts
        .import         ser_get_wait
        .import         ser_read_until
        .import         ser_discard_until

        .export         _x16_zi_init
        .export         _x16_zi_reset
        .export         _x16_zi_cmd
        .export         _x16_zi_wait_ok
        .export         _x16_zi_get_ip
        .export         _x16_zi_hex_open
        .export         _x16_zi_hex_chunk
        .export         _x16_zi_hex_close
        .export         _x16_zi_hexdecode
        .export         _x16_zi_delay
...
_x16_zi_init:
        sta     X16_P0                  ; divisor
        stx     X16_P1
        jsr     popax                   ; uart base: A = low, X = high
        jmp     zi_init
...
; ---------------------------------------------------------------------
_x16_zi_hexdecode:
        pha                             ; ndigits (rightmost arg, in A)
...
@inner:
        iny
        bne     @inner                  ; 256 inner steps
        inc     a
        bne     @mid                    ; 256 middle steps -> 65536 inner
        dex
        bne     @tick
@done:
        rts
...
zi_dest:    .res 2                      ; caller's current destination buffer
zi_fname:   .res 2
zi_linebuf: .res 90                     ; one hex line, read before decoding
