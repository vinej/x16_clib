...
void __fastcall__ x16_iec_second (unsigned char cmd);
void __fastcall__ x16_iec_tksa (unsigned char cmd);

/* One byte out to the listener / in from the talker. */
void __fastcall__ x16_iec_ciout (unsigned char b);
...
void __fastcall__ x16_iec_set_timeout (unsigned char t);
...
void __fastcall__ x16_iec_data_channel (unsigned char device,
                                        unsigned char secondary);
void __fastcall__ x16_iec_close_channel (unsigned char device,
                                         unsigned char secondary);

/* TALK device, then the DATA secondary command. */
void __fastcall__ x16_iec_talk_channel (unsigned char device,
                                        unsigned char secondary);
