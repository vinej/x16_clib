 ...
 * MSB-first, rows of 80 bytes, 19,200 bytes in all. A pixel byte lives
 * at y*80 + (x >> 2). Colours are 0-3 out of the first four palette
 * entries; x16_gfx2l_init() loads white / light gray / dark gray /
 ...
 *
 * x16_gfx2l_clear() fills through the VERA FX 32-bit cache: it needs an
...
void x16_gfx2l_vline (__reg("r0/r1") unsigned int x,
                     __reg("r2/r3") unsigned int y,
                     __reg("r4/r5") unsigned int len,
                     __reg("r6") unsigned char color);
...
void x16_gfx2l_frame (__reg("r0/r1") unsigned int x,
                     __reg("r2/r3") unsigned int y,
                     __reg("r4/r5") unsigned int w,
                     __reg("r6/r7") unsigned int h,
                     unsigned char color);
...
** proportional text affordable. h is 1-127.
*/
