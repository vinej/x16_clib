...
*/
unsigned char __fastcall__ x16_dos_delete (const char *name,
                                           unsigned char len);
unsigned char __fastcall__ x16_dos_mkdir (const char *name,
                                          unsigned char len);
unsigned char __fastcall__ x16_dos_rmdir (const char *name,
                                          unsigned char len);

/* "//" is the root. */
unsigned char __fastcall__ x16_dos_chdir (const char *name,
                                          unsigned char len);
