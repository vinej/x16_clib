...
;
; A separate module, not part of storage/bmx.s: vlink links a member
...
; vbcc argument registers: the name pointer rides r0/r1, the device --
; the char after a pointer -- the next even register, r2 (exactly as
; x16_bmx_load's len does).
        zpage	r0
        zpage	r1
        zpage	r2
...
; straight through the r0/r1 zero-page pair.
; ---------------------------------------------------------------------
_x16_bmx_load_hires:
        lda     r2
        sta     X16_P3                  ; device
