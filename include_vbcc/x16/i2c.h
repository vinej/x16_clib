...
unsigned int x16_i2c_read_byte (__reg("r0") unsigned char device,
                  __reg("r2") unsigned char offset);

/* One byte to a device register. Returns 1 on success, 0 on NAK. */
unsigned char x16_i2c_write_byte (__reg("r0") unsigned char device,
                   __reg("r2") unsigned char offset,
...
*/
unsigned char x16_i2c_batch_read (__reg("r0") unsigned char device,
                   __reg("r2/r3") void *buf,
                   __reg("r4/r5") unsigned int count,
                   __reg("r6") unsigned char fixed);
...
*/
unsigned int x16_i2c_batch_write (__reg("r0") unsigned char device,
                    __reg("r2/r3") const void *buf,
                    __reg("r4/r5") unsigned int count);
