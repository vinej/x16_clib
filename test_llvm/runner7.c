/* =====================================================================
 * x16clib :: test_llvm/runner7.c -- the storage wave: dir, fileio, iec,
 *                              ringbuffer, stack, and buffers' counters
 * =====================================================================
 * Standalone suite: run it with
 *
 *      .\build_llvm.ps1 -Test -Source test_ca65\runner6.c
 *
 ...
 * directory, which build_llvm.ps1 empties before the run.
 * ===================================================================== */
