...
- [`x16/bitmap2h.h` — 640x480x4 bitmap drawing (2bpp)](#x16bitmap2hh--640x480x4-bitmap-drawing-2bpp)
- [`x16/bitmap2l.h` — 320x240x4 bitmap drawing (2bpp)](#x16bitmap2lh--320x240x4-bitmap-drawing-2bpp)
- [`x16/bitmap4h.h` — VERA_2 640x480x16 SDRAM bitmap drawing](#x16bitmap4hh--vera-2-640x480x16-sdram-bitmap-drawing)
- [`x16/bitmap4l.h` — 320x240x16 bitmap drawing (4bpp)](#x16bitmap4lh--320x240x16-bitmap-drawing-4bpp)
- [`x16/bitmap8h.h` — VERA_2 640x480x256 SDRAM bitmap drawing](#x16bitmap8hh--vera-2-640x480x256-sdram-bitmap-drawing)
- [`x16/shapes.h` — circle / disc / ellipse / flood / polygon /](#x16shapesh--circle-disc-ellipse-flood-polygon)
- [`x16/verafx_utils.h` — low-level VERA FX primitives](#x16verafx_utilsh--low-level-vera-fx-primitives)
- [`x16/string.h` — NUL-terminated string toolkit](#x16stringh--nul-terminated-string-toolkit)
- [`x16/sort.h` — in-place sorting of arrays](#x16sorth--in-place-sorting-of-arrays)
- [`x16/bcd.h` — packed-BCD (decimal-mode) add and subtract](#x16bcdh--packed-bcd-decimal-mode-add-and-subtract)
- [`x16/bits.h` — bit and nibble helpers](#x16bitsh--bit-and-nibble-helpers)
- [`x16/number.h` — number formatting and parsing](#x16numberh--number-formatting-and-parsing)
- [`x16/tscrunch.h` — TSCrunch decompression](#x16tscrunchh--tscrunch-decompression)
- [`x16/fileio.h` — generic KERNAL file/channel I/O](#x16fileioh--generic-kernal-file-channel-i-o)
- [`x16/iec.h` — low-level IEC / serial bus wrappers](#x16iech--low-level-iec-serial-bus-wrappers)
- [`x16/dir.h` — reading a directory](#x16dirh--reading-a-directory)
- [`x16/ringbuffer.h` — an 8 KB FIFO ring in a HIRAM bank](#x16ringbufferh--an-8-kb-fifo-ring-in-a-hiram-bank)
- [`x16/stack.h` — an 8 KB LIFO stack in a HIRAM bank](#x16stackh--an-8-kb-lifo-stack-in-a-hiram-bank)
- [`x16/keyboard.h` — keyboard buffer and layout helpers](#x16keyboardh--keyboard-buffer-and-layout-helpers)
- [`x16/mouse.h` — the full KERNAL mouse surface](#x16mouseh--the-full-kernal-mouse-surface)
- [`x16/clock.h` — the jiffy timer and the real-time clock](#x16clockh--the-jiffy-timer-and-the-real-time-clock)
- [`x16/i2c.h` — the I2C bus: SMC, RTC, and friends](#x16i2ch--the-i2c-bus-smc-rtc-and-friends)
- [`x16/console.h` — the KERNAL console API](#x16consoleh--the-kernal-console-api)
- [`x16/graph.h` — the KERNAL GRAPH drawing API](#x16graphh--the-kernal-graph-drawing-api)
- [`x16/fb.h` — the KERNAL framebuffer driver API](#x16fbh--the-kernal-framebuffer-driver-api)
- [`x16/spi.h` — VERA SPI controller helpers](#x16spih--vera-spi-controller-helpers)
- [`x16/serial.h` — the serial / WiFi card UARTs](#x16serialh--the-serial-wifi-card-uarts)
- [`x16/zimodem.h` — ZiModem (ESP32 WiFi) over the serial card](#x16zimodemh--zimodem-esp32-wifi-over-the-serial-card)
- [`x16/audiorom.h` — the AUDIO ROM bank's API, wrapped](#x16audioromh--the-audio-rom-bank-s-api-wrapped)
- [`x16/wavfile.h` — parse a WAV/RIFF header](#x16wavfileh--parse-a-wav-riff-header)
- [`x16/zsm.h` — compact ZSM stream player](#x16zsmh--compact-zsm-stream-player)
- [`x16/vdc.h` — VERA display composer helpers](#x16vdch--vera-display-composer-helpers)
- [`x16/int16.h` — 16-bit integer arithmetic](#x16int16h--16-bit-integer-arithmetic)
- [`x16/int32.h` — 32-bit integer arithmetic](#x16int32h--32-bit-integer-arithmetic)
- [`x16/double.h` — 64-bit software floating point (binary64)](#x16doubleh--64-bit-software-floating-point-binary64)
- [`x16/filepick.h` — a file browser on a panel](#x16filepickh--a-file-browser-on-a-panel)
...
## `x16/shapes.h` — circle / disc / ellipse / flood / polygon /
