 ...
 *
 *      x16_ring_init(__reg("a") 6);               // take bank 6 for the queue
 *      x16_ring_put(__reg("a") 'H');
 *      x16_ring_putw(__reg("r0/r1") 300);
...
void x16_ring_init (__reg("a") unsigned char bank);

/* Enqueue a byte, or a word (low byte first). */
void x16_ring_put (__reg("a") unsigned char b);
void x16_ring_putw (__reg("r0/r1") unsigned int w);
