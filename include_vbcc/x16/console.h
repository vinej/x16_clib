 ...
 *
 *      x16_graph_init(NULL);
 *      x16_con_init(__reg("r0/r1") 0,
             __reg("r2/r3") 0,
             __reg("r4/r5") 0,
             __reg("r6/r7") 0);
 *      x16_con_put_char(__reg("r0") 'H',
                 __reg("r2") 1);       ...
 *
...
** Clears the area.
*/
void x16_con_init (__reg("r0/r1") unsigned int x,
...
** message is set.
*/
void x16_con_put_char (__reg("r0") unsigned char c,
                 __reg("r2") unsigned char wrap);
...
void x16_con_set_paging_message (__reg("r0/r1") const char *msg);
...
** oversized character.
*/
void x16_con_put_image (__reg("r0/r1") const unsigned char *image,
                  __reg("r2/r3") unsigned int width,
                  __reg("r4/r5") unsigned int height);
