...
; =====================================================================
        ...
        .export         _x16_gfx8h_has
        .export         _x16_gfx8h_init
        .export         _x16_gfx8h_off
        .export         _x16_gfx8h_passthru_on
        .export         _x16_gfx8h_passthru_off
        .export         _x16_gfx8h_pal_gray
        .export         _x16_gfx8h_pal_set
        .export         _x16_gfx8h_pal_load
        .export         _x16_gfx8h_setptr
        .export         _x16_gfx8h_clear
        .export         _x16_gfx8h_pset
        .export         _x16_gfx8h_read
        .export         _x16_gfx8h_hline
        .export         _x16_gfx8h_vline
        .export         _x16_gfx8h_rect
        .export         _x16_gfx8h_frame
        .export         _x16_gfx8h_line
        .export         _x16_gfx8h_pattern_set
        .export         _x16_gfx8h_pattern_rect
        .export         _x16_gfx8h_blit
        .export         _x16_gfx8h_blitm
        .export         _x16_gfx8h_copy
        .export         _x16_gfx8h_copy_wait
...
; void __fastcall__ x16_gfx8h_pal_set(unsigned char index,
...
; void __fastcall__ x16_gfx8h_pal_load(const unsigned char *src,
;                                     unsigned char first,
;                                     unsigned char count)
_x16_gfx8h_pal_load:
        sta     g8sh_c                  ; count
...
; void __fastcall__ x16_gfx8h_setptr(unsigned char inc,
...
; void __fastcall__ x16_gfx8h_clear(unsigned char color)
_x16_gfx8h_clear:
        jmp     gfx8h_clear

; void __fastcall__ x16_gfx8h_pset(unsigned int x, unsigned int y,
;                                 unsigned char color)
_x16_gfx8h_pset:
        sta     g8sh_c
        jsr     popax
...
; unsigned int __fastcall__ x16_gfx8h_read(unsigned int x, unsigned int y)
...
; void __fastcall__ x16_gfx8h_hline(unsigned int x, unsigned int y,
...
; void __fastcall__ x16_gfx8h_vline(unsigned int x, unsigned int y,
;                                  unsigned int len, unsigned char color)
_x16_gfx8h_vline:
        sta     g8sh_c
        jsr     popax
...
; void __fastcall__ x16_gfx8h_rect(unsigned int x, unsigned int y,
...
; void __fastcall__ x16_gfx8h_frame(unsigned int x, unsigned int y,
;                                  unsigned int w, unsigned int h,
;                                  unsigned char color)
_x16_gfx8h_frame:
        sta     g8sh_c
...
; void __fastcall__ x16_gfx8h_line(unsigned int x0, unsigned int y0,
...
; void __fastcall__ x16_gfx8h_pattern_set(const unsigned char *pattern,
...
; void __fastcall__ x16_gfx8h_pattern_rect(unsigned int x, unsigned int y,
;                                         unsigned int w, unsigned int h)
...
; void __fastcall__ x16_gfx8h_blit(unsigned int x, unsigned int y,
...
; void __fastcall__ x16_gfx8h_blitm(unsigned int x, unsigned int y,
;                                  unsigned char w, unsigned char h,
;                                  const unsigned char *src)
_x16_gfx8h_blitm:
        sta     X16_P6                  ; src
...
; void __fastcall__ x16_gfx8h_copy(unsigned long src, unsigned long dst,
;                                 unsigned long len)
