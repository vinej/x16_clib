...
__mem volatile unsigned char x16__hst_bank;    // the HIRAM bank we own
__mem volatile unsigned char x16__hst_sav;    // the caller's RAM_BANK
__mem volatile unsigned char x16__hst_v;      // the byte in transit
__mem volatile unsigned int x16__hst_sp;      // next free slot, counting down
