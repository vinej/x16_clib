/* =====================================================================
 * x16clib :: test_kickc/runner9.c -- the storage wave: ringbuffer, stack,
 *                                    fileio, iec, dir
 * =====================================================================
 * Standalone suite:
 *
 *      .\build_kickc.ps1 -Test -Source test_kickc\runner9.c
 *
 ...
 *
 * WRITTEN IN KickC's IDIOM rather than transliterated from ca65's
 ...
 * directory, which build_kickc.ps1 empties before the run.
 * ===================================================================== */
