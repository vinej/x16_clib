...
; =====================================================================
        ...
        .export         _x16_ring_init
        .export         _x16_ring_put
        .export         _x16_ring_putw
        .export         _x16_ring_get
        .export         _x16_ring_getw
        .export         _x16_ring_size
        .export         _x16_ring_free
        .export         _x16_ring_isempty
        .export         _x16_ring_isfull
...
ring_bank: .res 1              ; the HIRAM bank the queue owns
ring_fill: .res 2              ; bytes currently queued
ring_head: .res 2              ; where the next put goes
ring_tail: .res 2              ; one before where the next get comes from
