...
void __fastcall__ x16_d_load (const x16_double m);
void __fastcall__ x16_d_store (x16_double m);
...
*/
void __fastcall__ x16_d_add (const x16_double m);
void __fastcall__ x16_d_sub (const x16_double m);
void __fastcall__ x16_d_mul (const x16_double m);
void __fastcall__ x16_d_div (const x16_double m);
...
*/
void __fastcall__ x16_d_pow (const x16_double m);
