...
; vbcc argument registers: pcm_write takes src in r0/r1, count in r2/r3.
        zpage	r0
        zpage	r1
        zpage	r2
        zpage	r3

        global	_x16_pcm_ctrl
        global	_x16_pcm_rate
        global	_x16_pcm_reset
        global	_x16_pcm_full
        global	_x16_pcm_empty
        global	_x16_pcm_put
        global	_x16_pcm_write
...
;   pcm_write wants P0/P1 = src, P2/P3 = count.
_x16_pcm_write:
        lda     r0
        sta     X16_P0                  ; src
        lda     r1
