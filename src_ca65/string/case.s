...
; =====================================================================
        ...
        .export         _x16_str_lowerchar
        .export         _x16_str_lowerchar_iso
        .export         _x16_str_upperchar
        .export         _x16_str_upperchar_iso
        .export         _x16_str_lower
        .export         _x16_str_lower_iso
        .export         _x16_str_upper
        .export         _x16_str_upper_iso
        .export         _x16_str_compare_nocase
        .export         _x16_str_compare_nocase_iso
...
; ...and upperchar, and the _iso pair. The character already arrives in
; A: no shim beyond the return convention.
; ---------------------------------------------------------------------
_x16_str_lowerchar:
        jsr     str_lowerchar
...
; greater -- the asm's $FF sign-extended so C sees a true -1.
; ---------------------------------------------------------------------
