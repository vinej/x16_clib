...
; vbcc argument registers. bmx_load/save: name in r0/r1, len in r2, device
; in r4, and the 32-bit vaddr in btmp0..btmp0+2. get_info/set_info take a
; single struct pointer in the a/x pair, staged in X16_PTR2.
        zpage	r0
        zpage	r1
        zpage	r2
        zpage	r4
...
; name in r0/r1, len in r2, device in r4, vaddr (long) in btmp0..btmp0+2
...
; The struct pointer arrives in the a/x pair; stage it in X16_PTR2.
_x16_bmx_get_info:
        sta     X16_PTR2
        stx     X16_PTR2+1
        ldy     #BMX_INFO_SIZE - 1
...
bmx_row:  reserve 2
bmx_rows: reserve 2
bmx_t:    reserve 1                        ; bulk_read's subtrahend
