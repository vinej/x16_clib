...
void x16_f_load (const x16_float m);
void x16_f_store (x16_float m);

/* FAC op= m. */
void x16_f_add (const x16_float m);
void x16_f_sub (const x16_float m);
void x16_f_mul (const x16_float m);
void x16_f_div (const x16_float m);
...
*/
void x16_f_rsub (const x16_float m);
void x16_f_rdiv (const x16_float m);
