 ...
 * offset = y*320 + (x>>1), 153,600 bytes in all. The VERA_2 layer has
 * its own 16-entry palette ($9F66-$9F68), separate from VERA's.
 *
...
void x16_gfx4h_vline (__reg("r0/r1") unsigned int x,
                     __reg("r2/r3") unsigned int y,
                     __reg("r4/r5") unsigned int len,
                     __reg("r6") unsigned char color);
...
void x16_gfx4h_rect (__reg("r0/r1") unsigned int x,
                    ...
                    unsigned char color);
void x16_gfx4h_frame (__reg("r0/r1") unsigned int x,
                     __reg("r2/r3") unsigned int y,
                     __reg("r4/r5") unsigned int w,
                     __reg("r6/r7") unsigned int h,
                     unsigned char color);
...
** 2 AND, 3 XOR. No clipping. op is the sixth argument, so it rides
** the soft stack.
*/
