...
; (import: str_compare); from string/string.s -- vlink resolves it by name
; vbcc argument registers: the array pointer rides r0/r1, the count r2/r3.
        zpage	r0
        zpage	r1
        zpage	r2
        zpage	r3

        global	_x16_str_sort
