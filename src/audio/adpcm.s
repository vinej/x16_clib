...
; =====================================================================
        ...
        .export         _x16_adpcm_init
        .export         _x16_adpcm_nibble
        .export         _x16_adpcm_block
        .export         _x16_adpcm_set_state
        .export         _x16_adpcm_predictor
        .export         _x16_adpcm_index
...
_x16_adpcm_set_state:
        sta     adpcm_index             ; index (rightmost arg, in A)
        jsr     popax                   ; predictor
        sta     adpcm_pred
        stx     adpcm_pred+1
        rts
...
; ---------------------------------------------------------------------
_x16_adpcm_block:
        sta     X16_P4                  ; source count (rightmost arg: A/X)
        stx     X16_P5
        jsr     popax
        sta     X16_P2                  ; dst
        stx     X16_P3
...
adpcm_pred:  .res 2                     ; the predictor (signed 16-bit sample)
adpcm_index: .res 1                     ; step table index 0-88
