 ...
 *
 *      x16_stack_init(__reg("a") 5);              // take bank 5 for the stack
 *      x16_stack_push(__reg("a") 42);
 *      x16_stack_pushw(__reg("r0/r1") 1000);
...
void x16_stack_init (__reg("a") unsigned char bank);

/* Push a byte, or a word. */
void x16_stack_push (__reg("a") unsigned char b);
void x16_stack_pushw (__reg("r0/r1") unsigned int w);
