...
** even "did the DAC start" is unobservable. Crossing those two arguments
** in the shim passes this test. What pins them is the disassembly of the
** shim against the compiler's own argument setup.
*/
