...
; vbcc argument registers: a string pointer rides r0/r1, the searched
; character (or a second pointer) r2/r3. Returns: char in a.
        zpage	r0
        zpage	r1
        zpage	r2
        zpage	r3
...
CH_QMARK = $3F                          ; '?'
        ...
        global	_x16_str_find
        global	_x16_str_rfind
        global	_x16_str_contains
        global	_x16_str_find_eol
        global	_x16_str_pattern_match
...
;   The asm wants A/X = s and the character in Y.
; ---------------------------------------------------------------------
_x16_str_find:
        ldy     r2                      ; Y = the character
        lda     r0
        ldx     r1
...
;   The asm wants A/X = s, P0/P1 = pattern.
; ---------------------------------------------------------------------
