...
/* Clipped. */
void x16_gfx8l_pset (unsigned int x, unsigned char y,
                                unsigned char color);

/* Unclipped from here down. */
void x16_gfx8l_hline (unsigned int x, unsigned char y,
                                 unsigned int len, unsigned char color);

/* len is 1-255: a column of a 240-row screen never needs more. */
void x16_gfx8l_vline (unsigned int x, unsigned char y,
                                 unsigned char len, unsigned char color);

void x16_gfx8l_rect (unsigned int x, unsigned char y,
                                unsigned int w, unsigned char h,
                                unsigned char color);

void x16_gfx8l_frame (unsigned int x, unsigned char y,
                                 unsigned int w, unsigned char h,
                                 unsigned char color);
...
*/
void x16_gfx8l_line (unsigned int x0, unsigned char y0,
...
*/
void x16_gfx8l_char (unsigned int x, unsigned char y,
...
*/
void x16_gfx8l_text (unsigned int x, unsigned char y,
...
*/
void x16_gfx8l_blit (unsigned int x, unsigned int y,
...
*/
void x16_gfx8l_blitm (unsigned int x, unsigned int y,
                                 unsigned char w, unsigned char h,
                                 const unsigned char *src);

/* pulls the implementation in with this header */
#pragma compile("bitmap8l.c")
