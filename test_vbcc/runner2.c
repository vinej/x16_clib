...
static void test_curves(void)
{
    ...
    x16_gfx2h_fpolygon(40, 20, 12, 4, 0, 2);         /* filled square */
    t_check(x16_gfx2h_read(40, 20) == 2 &&
            x16_gfx2h_read(40, 7) == 0, "CURVE_POLYGON");

    x16_vera_addr0(X16_INC_1, X16_VRAM_BITMAP);
    x16_vera_fill(0x00, 160UL * 41);
    x16_gfx2h_frrect(20, 4, 40, 30, 8, 2);
    t_check(x16_gfx2h_read(40, 19) == 2 &&
            x16_gfx2h_read(20, 4) == 0, "CURVE_RRECT");

    x16_vera_addr0(X16_INC_1, X16_VRAM_BITMAP);
    x16_vera_fill(0x00, 160UL * 41);
    x16_gfx2h_arc(40, 20, 15, 0, 64, 3);             /* east -> south */
    t_check(x16_gfx2h_read(55, 20) == 3 &&
            x16_gfx2h_read(40, 35) == 3 &&
            x16_gfx2h_read(25, 20) == 0, "CURVE_ARC");
    ...
    t_check(x16_gfx2h_read(40, 20) == 3 &&
            ...
            x16_gfx2h_read(35, 15) == 0, "CURVE_PIE");
    ...
    t_check(x16_gfx2h_read(20, 20) == 3 &&
            ...
            x16_gfx2h_read(35, 20) == 3, "CURVE_BEZIER");
}
